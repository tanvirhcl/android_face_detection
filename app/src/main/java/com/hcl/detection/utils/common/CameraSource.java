...
import com.hcl.detection.utils.interfaces.VisionImageProcessor;
...
public class CameraSource {
  ...
  private static class SizePair {
    ...
    SizePair(Camera.Size previewSize, @Nullable Camera.Size pictureSize) {
      ...
      if (pictureSize != null) picture = new Size(pictureSize.width, pictureSize.height);
    }
  ...
  private void setRotation(Camera camera, Camera.Parameters parameters, int cameraId) {
    ...
    switch (rotation) {
      ...
      default: Log.e(TAG, "Bad rotation value: " + rotation);
    }
